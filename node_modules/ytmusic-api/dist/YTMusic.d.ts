import { z } from "zod";
import { AlbumDetailed, AlbumFull, ArtistDetailed, ArtistFull, PlaylistFull, SearchResult, SongDetailed, SongFull, VideoDetailed, VideoFull } from "./schemas";
export default class YTMusic {
     ...
     * @param query Query string
     */
    searchPlaylists(query: string): Promise<z.infer<typeof PlaylistFull>[]>;
    /**
