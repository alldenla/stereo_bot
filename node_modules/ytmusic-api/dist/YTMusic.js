...
class YTMusic {
    ...
    async search(query) {
        ...
        return (0, traverseList_1.default)(searchData, "musicResponsiveListItemRenderer").map(SearchParser_1.default.parse);
    }
    /**
    ...
    async getArtistAlbums(artistId) {
        ...
        return (0, traverseList_1.default)(albumsData, "musicTwoRowItemRenderer").map(item => AlbumParser_1.default.parseArtistAlbum(item, {
            artistId,
            name: (0, traverseString_1.default)(albumsData, "header", "text")()
        }));
    }
    /**
